...
export default function AdminLayout({ header, children }) {
    ...
    {/* Sidebar */}
    <aside className="w-60 bg-gray-900 text-gray-200 h-screen shadow-lg flex flex-col">
        ...
        <nav className="mt-4 flex-grow">
            <ul className="space-y-2">
                {[
                    ...
                    { name: "AssignJudgeToCandidate", routeName: "AasignCandidate" },
                    { name: "AssignJudgeToSegment", routeName: "AasignSegment" },
